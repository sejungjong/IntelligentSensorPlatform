package com.aisl.ksensor.resourcemanager.common.code;

import com.fasterxml.jackson.annotation.JsonCreator;
import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.annotation.JsonValue;

public class ResourceManagerCode {

    public static enum ResourceType {

        @JsonProperty("applicationEntity")
        ...
        @JsonValue
        public static ResourceType parseType(String code) {
    ...
    public static enum ProvisioningSubUri {
        ...
        SENSOR_MANAGER("/provision/sensorsetup"),
